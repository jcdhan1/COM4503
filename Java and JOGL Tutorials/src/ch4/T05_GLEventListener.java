...
public class T05_GLEventListener implements GLEventListener {
	...
	public void initialise(GL3 gl) {
		...
		shader = new Shader(gl, user_dir + "\\src\\ch4\\vs_T05.glsl", user_dir + "\\src\\ch4\\fs_T05.glsl");
		//shader = new Shader(gl, "vs_T05.txt", "fs_T05.txt");

		fillBuffers(gl);
		textureId1 = TextureLibrary.loadTexture(gl, user_dir + "\\src\\ch4\\paintstrokes\\wattBook.jpg");
		textureId2 = TextureLibrary.loadTexture(gl, user_dir + "\\src\\ch4\\paintstrokes\\wattBook1.jpg");
		textureId3 = TextureLibrary.loadTexture(gl, user_dir + "\\src\\ch4\\paintstrokes\\wattBook2.jpg");
		textureId4 = TextureLibrary.loadTexture(gl, user_dir + "\\src\\ch4\\paintstrokes\\wattBook3.jpg");
