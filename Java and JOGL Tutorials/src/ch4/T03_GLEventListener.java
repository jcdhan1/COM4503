...
public class T03_GLEventListener implements GLEventListener {

	private static final boolean DISPLAY_SHADERS = false;
	private Shader shader;

	/* The constructor is not used to initialise anything */
	public T03_GLEventListener() {
	}
	...
	public void initialise(GL3 gl) {
		...
		shader = new Shader(gl, user_dir + "\\src\\ch4\\vs_T03.glsl", user_dir + "\\src\\ch4\\fs_T03.glsl");
		fillBuffers(gl);
		...
		textureId3 = TextureLibrary.loadTexture(gl, user_dir + "\\src\\ch4\\cloud.jpg");
