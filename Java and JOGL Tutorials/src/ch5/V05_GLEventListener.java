...
public class V05_GLEventListener implements GLEventListener {
	...
	/* Called to indicate the drawing surface has been moved and/or resized.
	   Also called once when program first launches. */
	...
	public void initialise(GL3 gl) {String user_dir = System.getProperty("user.dir");
		...
		fillBuffers(gl);
		textureId1 = TextureLibrary.loadTexture(gl, user_dir + "\\src\\ch5\\cube.jpg");
	}
	...
	private Mat4 getViewMatrix() {
		...
		float zposition = 10;
		float xposition = 0;
		Mat4 viewMatrix = Mat4Transform.lookAt(new Vec3(xposition, 0, zposition), new Vec3(0, 0, 0), new Vec3(0, 1, 0));
		return viewMatrix;
	}
