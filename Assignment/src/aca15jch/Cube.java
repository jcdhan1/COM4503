package aca15jch;
/**
 * Code reused from Dr. Maddock's Cube class but "final" has been removed from the fields for the subclass CubeNet.
 */
public class Cube {
	public static float[] vertices = new float[]{  // x,y,z, nx,ny,nz, s,t
